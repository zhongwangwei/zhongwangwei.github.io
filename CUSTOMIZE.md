...
The research is structured as follows, focusing on the main components that you will need to modify:
...
├── 📂 _research/: contains the research
...
You can create new research by adding new Markdown files in the [\_research](_research/) directory. The easiest way to do this is to copy an existing research and modify it.
...
This Jekyll theme implements `collections` to let you break up your work into categories. The theme comes with two default collections: `news` and `research`. Items from the `news` collection are automatically displayed on the home page. Items from the `research` collection are displayed on a responsive grid on research page.
