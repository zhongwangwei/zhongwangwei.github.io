---
layout: page
title: Terrestrial Water Cycle Research
description: Terrestrial Water Cycle Research
img: assets/img/research/watercycle/luo.png
importance: 5
category: work
...
**<span style="color: #27ae60; font-weight: bold; font-size: 1.1em;">Terrestrial Water Cycle Research</span>**
...
<div class="row justify-content-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid 
            path="assets/img/research/watercycle/TbyET.png" 
...
<div class="row justify-content-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid 
            path="assets/img/research/watercycle/p.png" 
            title="Global Simulation Results" 
            class="img-fluid rounded z-depth-1" %}
    </div>
</div>
